...
class NewsletterListView( HasAdminAccessPermission, LoginRequiredMixin, ListView):
    title = "لیست خبرنامه"
...
class NewsletterDeleteView( HasAdminAccessPermission, LoginRequiredMixin, SuccessMessageMixin, DeleteView):
    title = "حذف خبرنامه"
