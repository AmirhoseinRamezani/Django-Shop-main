...
class AdminProductCreateView( HasAdminAccessPermission, LoginRequiredMixin, SuccessMessageMixin, CreateView):
...
class AdminProductEditView( HasAdminAccessPermission, LoginRequiredMixin, SuccessMessageMixin, UpdateView):
...
class AdminProductDeleteView( HasAdminAccessPermission, LoginRequiredMixin, SuccessMessageMixin, DeleteView):
...
class AdminProductAddImageView( HasAdminAccessPermission, LoginRequiredMixin, CreateView):
...
class AdminProductRemoveImageView( HasAdminAccessPermission, LoginRequiredMixin, SuccessMessageMixin, DeleteView):
    http_method_names = ["post"]
