...
class UserListView(HasAdminAccessPermission, LoginRequiredMixin, ListView):
    title = "لیست کاربران"
...
class UserDeleteView( HasAdminAccessPermission, LoginRequiredMixin,SuccessMessageMixin, DeleteView):
    title = "حذف کاربر"
...
class UserUpdateView( HasAdminAccessPermission, LoginRequiredMixin,SuccessMessageMixin, UpdateView):
    title = "ویرایش کاربر"
